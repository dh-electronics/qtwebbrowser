...
**
** Modified work Copyright (C) 2019  DH Electroncis GmbH
...
Rectangle {
    ...
    property QtObject otrProfile: WebEngineProfile {
        ...
        Component.onCompleted: {
            httpUserAgent = httpUserAgent + " " + GlobalSettings.httpUserAgent
        }
    }
    ...
    Component {
        ...
        Rectangle {
            ...
            WebEngineView {
                ...
                url: GlobalSettings.defaultUrl //"https://badssl.com"
            ...
            TouchTracker {
                id: tracker
                enabled: (!GlobalSettings.kioskmodeEnabled && GlobalSettings.touchtrackingEnabled) ? root.interactive:false
        ...
        Rectangle {
            ...
            states: [
                State {
                    ...
                    PropertyChanges { target: navigation; fullscreenMode: false }
                },
                State {
                    name: "list"
                ...
                State {
                    ...
                    PropertyChanges { target: pathView; interactive: false }
                    PropertyChanges { target: item; opacity: 1.0 }
                    PropertyChanges { target: navigation; fullscreenMode: true }
                }
            ]
